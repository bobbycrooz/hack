	...
	return (
		<section id="contact" className="contact_section bg-base w-screen min-h-screen">
			...
			<div className="content flex justify-center w-full mt-6">
				{/*  */}
				<ul className="sm:flex flex-col space-y-3 mt-[60px] hidden">
				...
				<div className="sm:w-[225px]"></div>
				{/* Form */}
				<div className="form_box-w sm:px-[90px] px-[50px] py-[65px] space-y-[34px]">
					<div className="text-base-2 font-Cd-SemiBold">
						...
						<p className="text-white font-mon text-[12px] mt-6">Email us below to any question related to our event</p>
					</div>
