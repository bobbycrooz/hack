...
const Big: React.FC = () => {
	...
	return (
		<>
			<section className="w-full bg-base sm:py-[56px] border-b border-[#FFFFFF2E] flex flex-col px-[49px] py-[30px] sm:flex-row sm:justify-center sm:px-[200px] items-center">
				...
				{/* text */}
				<div className="w-full  sm:w-[470px] text-center sm:text-left relative">
					<img src="/h-star-b1.svg" alt="" className="star absolute   animate-pulse top-[20px] -right-[50px] " />
			...
			<section
				id="rules"
				className="w-full bg-base sm:py-[56px] py-[24px] px-[48px]  border-b border-[#FFFFFF2E] flex flex-col-reverse sm:flex-row justify-center sm:px-[200px] items-center relative"
			>
				...
				<div className="  sm:w-[540px] relative w-full text-center sm:text-left">
					<img src="/h-star.svg" alt="" className=" left-[250px] -top-[0px] absolute animate-pulse " />
					<img src="/h-star-white.svg" alt="" className="star absolute   animate-pulse -bottom-[50px] -right-[70px] " />

					<h1 className="into font-cd-bold sm:text-[32px] text-[20px] relative">Rules and</h1>
			...
			<section
				id="people"
				className="w-full bg-base py-[56px] border-b border-[#FFFFFF2E] flex flex-col sm:flex-row justify-center md:px-[200px] px-[24px] items-center"
			>
				<div className="img w-full sm:w-[590px] h-[330px] sm:h-[500px] relative">
					<img src="/h-people.png" className="w-full h-full" alt="" />
					{/* stars */}
						<img src="/h-star-b1.svg" alt="" className=" left-[0px] -top-[50px] absolute animate-pulse " />
					<img src="/h-star.svg" alt="" className="star absolute   animate-pulse bottom-[50%] right-[50%] " />
					<img src="/h-star-white.svg" alt="" className="star absolute   animate-pulse -bottom-[50px] -right-[70px] " />
				...
				<div className="w-full text-center sm:text-left  sm:w-[470px]">
					...
					<div className="w-auto space-y-4 text-center sm:text-left">
						{featureList.map((i: any, k: number) => (
							<p
								key={k}
								className="body font-mon sm:text-sm text-xs leading-[22.555px] sm:leading-[27.56px]   sm:w-[90%]"
							>
			...
			<section
				id="ask"
				className="w-full bg-base py-[56px] border-b border-[#ffffff4d] flex flex-col sm:flex-row justify-center sm:px-[200px]  px-[40px] items-center relative"
			>
				...
				<div className="w-full  sm:w-[540px] relative text-center sm:text-left">
					...
					<div className="quest_faq w-full h-auto space-y-6 sm:mt-[60px] mt-[40px]">
						{faqLiat.map((i: string, k: number) => (
							<div
								key={k}
								className=" border-b-2 border-base-2 sm:h-10 h-14 flex items-start justify-between w-full  sm:w-[427px]"
							>
